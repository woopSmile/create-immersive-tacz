...
public class ModFluids {
    ...
    public static final RegistryObject<FlowingFluid> SOURCE_GUNPOWDER = FLUIDS.register("gunpowder_fluid",
            () -> new BaseFlowingFluid.Source(ModFluids.GUNPOWDER_FLUID_PROPERTIES));
    public static final RegistryObject<FlowingFluid> FLOWING_GUNPOWDER = FLUIDS.register("flowing_gunpowder_fluid",
            () -> new BaseFlowingFluid.Flowing(ModFluids.GUNPOWDER_FLUID_PROPERTIES));

    public static final BaseFlowingFluid.Properties GUNPOWDER_FLUID_PROPERTIES = new BaseFlowingFluid.Properties(
    ...
    public static final RegistryObject<FlowingFluid> SOURCE_NITROPOWDER = FLUIDS.register("nitropowder_fluid",
            () -> new BaseFlowingFluid.Source(ModFluids.NITROPOWDER_FLUID_PROPERTIES));
    public static final RegistryObject<FlowingFluid> FLOWING_NITROPOWDER = FLUIDS.register("flowing_nitropowder_fluid",
            () -> new BaseFlowingFluid.Flowing(ModFluids.NITROPOWDER_FLUID_PROPERTIES));

    public static final BaseFlowingFluid.Properties NITROPOWDER_FLUID_PROPERTIES = new BaseFlowingFluid.Properties(
